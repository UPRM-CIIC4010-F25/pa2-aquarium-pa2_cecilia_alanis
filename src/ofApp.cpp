...
void ofApp::setup(){
    ...
    myAquarium->addAquariumLevel(std::make_shared<Level_3>(3, 25));     // Added Level 3
    myAquarium->addAquariumLevel(std::make_shared<Level_4>(4, 35));     // Added Level 4
    myAquarium->addAquariumLevel(std::make_shared<Level_5>(5, 50));     // Added Level 5
